<div class="row">
    <div class="col-md-12">
        ...
        <input class="form-control" type="text" name="name" id="name" placeholder="Digita o Ano Lectivo"
            required value={{ isset($schoolyear->name) ? $schoolyear->name : '' }}>
    </div>
    <div class="col-md-12">
        <label for="nBi">Detalhes</label>
        <textarea class="form-control" name="details" id="details" cols="30" rows="5" placeholder="Detalhes do Ano Lectivo">{{ isset($schoolyear->details) ? $schoolyear->details : '' }}</textarea>
    </div>

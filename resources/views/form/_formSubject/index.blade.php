<div class="row">
    ...
    <div class="col-md-12 py-2">
        ...
        <textarea class="form-control" name="details" id="details" cols="30" rows="5" placeholder="Detalhes da Disciplina">{{ isset($subject->details) ? $subject->details : old('details') }}</textarea>
    </div>

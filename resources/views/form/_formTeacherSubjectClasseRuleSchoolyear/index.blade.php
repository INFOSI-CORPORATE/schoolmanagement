    ...
    <div class="col-md-6 py-2">
        ...
        <select class="form-control" name="fk_teachers_id" id="fk_teachers_id">
            ...
            @foreach ($teachers as $teacher)
                <option value="{{ $teacher->id }}" {{ (isset($teacherSubjectClasseRuleSchoolyear) && $teacherSubjectClasseRuleSchoolyear->teachers->id == $teacher->id ) ? 'selected' : '' }}>{{ $teacher->name }}</option>
            @endforeach
    ...
    <div class="col-md-6 py-2">
        ...
        <select class="form-control" name="fk_subjects_id" id="fk_subjects_id">
            ...
            @foreach ($subjects as $subject)
                <option value="{{ $subject->id }}" {{ (isset($teacherSubjectClasseRuleSchoolyear) && $teacherSubjectClasseRuleSchoolyear->subjects->id == $subject->id ) ? 'selected' : '' }}>{{ $subject->name }}</option>
            @endforeach
        </select>
    </div>
    ...
    <div class="col-md-6 py-2">
        ...
        <select class="form-control" name="fk_classes_id" id="fk_classes_id">
            ...
            @foreach ($classes as $classe)
                <option value="{{ $classe->id }}" {{ (isset($teacherSubjectClasseRuleSchoolyear) && $teacherSubjectClasseRuleSchoolyear->classes->id == $classe->id ) ? 'selected' : '' }}>{{ $classe->name }}</option>
            @endforeach
        </select>
    </div>
    ...
    <div class="col-md-6 py-2">
        ...
        <select class="form-control" name="fk_rules_id" id="fk_rules_id">
            ...
            @foreach ($rules as $rule)
                <option value="{{ $rule->id }}" {{ (isset($teacherSubjectClasseRuleSchoolyear) && $teacherSubjectClasseRuleSchoolyear->rules->id == $rule->id ) ? 'selected' : '' }}>{{ $rule->name }}</option>
            @endforeach
        </select>
    </div>
    ...
    <div class="col-md-6 py-2">
        ...
        <select class="form-control" name="fk_schoolyears_id" id="fk_schoolyears_id">
            ...
            @foreach ($schoolyears as $schoolyear)
                <option value="{{ $schoolyear->id }}" {{ (isset($teacherSubjectClasseRuleSchoolyear) && $teacherSubjectClasseRuleSchoolyear->schoolyears->id == $schoolyear->id ) ? 'selected' : '' }}>{{ $schoolyear->name }}</option>
            @endforeach
        </select>
    </div>
    <div class="col-md-6 py-2">

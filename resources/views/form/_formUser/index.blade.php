...
<div class="row">
    ...
    <div class="col-md-6 py-2">
        ...
        <input class="form-control" type="text" name="name" id="name"
            placeholder="Digite o Nome" required value="{{ isset($user->name) ? $user->name : old('name') }}">
    </div>
    
    <div class="col-md-6 py-2">
        <label for="email">Endereço de E-mail</label>
        <input class="form-control" type="email" name="email" id="email" placeholder="Digite o E-mail"
            required value="{{ isset($user->email) ? $user->email : old('email') }}">
    </div>
    ...
    <div class="col-md-6 py-2">
        ...
        <input class="form-control" type="password" name="password_confirmation" id="password_confirmation" placeholder="Digite a Palavra-Passe Novamente"

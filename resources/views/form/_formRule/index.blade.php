<div class="row">
    ...
    <div class="col-md-12 py-2">
        ...
        <textarea class="form-control" name="details" id="details" cols="30" rows="5" placeholder="Digite os Detalhes">{{ isset($rule->details) ? $rule->details : old('details') }}</textarea>
    </div>

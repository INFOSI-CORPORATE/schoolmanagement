<div class="row">
    <div class="col-md-6 py-2">
        ...
        <input class="form-control" type="text" name="title" id="title" placeholder="Digite o título da atividade"
    ...
    <div class="col-md-6 py-2">
        ...
        <input class="form-control" type="text" name="location" id="location"
            placeholder="Digite o local da atividade" required
    ...
    <div class="col-md-12 py-2">
        ...
        <textarea class="form-control" name="details" id="details" cols="30" rows="10" placeholder="Digite a descrição da Atividade">{{ isset($ativitie->details) ? $ativitie->details : old('details') }}</textarea>
    </div>

...
<head>
    ...
    <title>tuition - {{ date('d-m-Y') }}</title>
...
<body style='height:auto; width:100%; background: url("dashboard/images/digital.canvas.png") no-repeat center;'>
    <header class="header">
        ...
        <div class="text-center">lista de alunos inscritos do ano de "{{ $tuition->schoolyears->name }}"</div>
    </header>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 mt-2">
                    <h5 class=""><b>Informações da Propina </b> </h5>
                    <hr>
                </div>
                ...
                <div style="" class="col-12 mb-5">
                    ...
                    <div style="display: inline-block;" class="mr-4">
                        <b>Nome do Aluno</b>
                        <p>{{ $tuition->students->name }}</p>

                        <b>Nº de Processo</b>
                        <p>{{ $tuition->students->nProcess }}</p>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td>{{ $tuition->month }}</td>
                                <td>{!! number_format($tuition->price, 2, ',', '.') . ' ' . 'kz' !!}</td>
                                <td>{{ $tuition->state }}</td>
                            </tr>
                        </tbody>
                    </table>

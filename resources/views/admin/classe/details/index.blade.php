        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Detalhes da Turma</h1>
                </div>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    ...
                                    <p class="text-dark">{{ $classe->details }}</p>
                                </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-7 mb-2">
                                    <hr>
                                    <p class="mb-1 text-dark"><b>Data de Cadastro</b> {{ $classe->created_at }}
                                    </p>
                                    <p class="mb-1 text-dark"><b>Última Actualização</b> {{ $classe->updated_at }}
                                    </p>

                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    <h5>
                                        <b class="mb-1">Nível de Acesso</b>
                                    </h5>
                                    <p class="text-dark">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-7 mb-2">
                                    <hr>
                                    <p class="mb-1 text-dark"><b>Data de Cadastro</b> {{ $user->created_at }}
                                    </p>
                                    <p class="mb-1 text-dark"><b>Última Actualização</b> {{ $user->updated_at }}
                                    </p>

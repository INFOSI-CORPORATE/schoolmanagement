...
class CreateContractsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('contracts', function (Blueprint $table) {
            ...
            $table->foreign('fk_rules_id')->references('id')->on('rules')->onDelete('CASCADE')->onUpclasse('CASCADE');

            $table->unsignedBigInteger('fk_schoolyears_id');
            $table->foreign('fk_schoolyears_id')->references('id')->on('schoolyears')->onDelete('CASCADE')->onUpclasse('CASCADE');
